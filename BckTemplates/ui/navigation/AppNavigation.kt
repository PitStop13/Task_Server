...
fun AppNavigation(
    ...
    // Mostra la rotella solo nelle schermate principali
    // Valuta se mostrare la TopAppBar personalizzata o quella di sistema
    val isMainScreen = bottomRoutes.any { currentRoute == it }
    ...
    TaskServerTheme(darkTheme = isDarkMode) {
        Scaffold(
                        ...
                        bottomNavItems.forEach { screen ->
                            ...
                            NavigationBarItem(
                                ...
                                colors = NavigationBarItemDefaults.colors(
                                    selectedIconColor = if (screen == Screen.Tasks) PurpleSecondary else CyanPrimary,
                                    selectedTextColor = if (screen == Screen.Tasks) PurpleSecondary else CyanPrimary,
            ...
            floatingActionButton = {
                // Rimosso il FloatingActionButton per le impostazioni
            }
        ) { innerPadding ->
            NavHost(
                ...
                // Server edit: serverId=-1 => nuovo server
                composable(
                ...
                // Task builder: taskId=-1 => nuovo task
                composable(
